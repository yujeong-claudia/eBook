...
<div class="d-flex justify-content-center">    
	<div class="book-detail-box">
		<div class="d-flex border border-success">
			...
			<div class="mt-3">
				<div class="d-flex justify-content-center">
					...
					<img src="https://www.iconninja.com/files/214/518/441/heart-icon.png" class="mt-2" width="30" height="30" alt="empty heart">
				</div>
		...
		<a href="/review/review-list-view" class="text-secondary mt-4">리뷰 보러가기</a>
	</div>
</div>